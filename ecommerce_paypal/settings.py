"""
Django settings for ecommerce_paypal project.
...
SECRET_KEY = '%4r2fyr&ch*b$9y@w%qb7wv8!)*4_2e_wue8)y934sk^z4z3wq'
...
ROOT_URLCONF = 'ecommerce_paypal.urls'
...
WSGI_APPLICATION = 'ecommerce_paypal.wsgi.application'
